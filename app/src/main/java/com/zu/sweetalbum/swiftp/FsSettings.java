...
public class FsSettings {
    ...
    public static void setAllowAnonymous(boolean allowAnonymous)
    {
        final SharedPreferences sp = getSharedPreferences();
        SharedPreferences.Editor editor = sp.edit();
        editor.putBoolean("allow_anonymous", allowAnonymous);
        editor.apply();
    }
    ...
    public static void setTakeFullWakeLock(boolean b)
    {
        final SharedPreferences sp = getSharedPreferences();
        SharedPreferences.Editor editor = sp.edit();
        editor.putBoolean("stayAwake", b);
        editor.apply();
    }
