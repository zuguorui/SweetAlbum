...
/**
 * Created by zu on 17-11-2.
 */

public class DragToLoadLayout2 extends FrameLayout implements NestedScrollingChild, NestedScrollingParent {
    ...
    public DragToLoadLayout2(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DragToLoadLayout2(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
