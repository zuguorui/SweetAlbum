...
public class SlideLayout extends FrameLayout {
    ...
    public void computeScroll() {
        ...
        if(mScroller != null && mScroller.computeScrollOffset())
        {
            ...
            notifyOnSlideListeners(getSlideState());
            postInvalidate();
        }
    }
    ...
    public float getSlideState()
    {
        int leftMargin = getViewLeftMargin(slideView);
        return Math.abs((leftMargin *1.0f) / slideViewWidth);
    }
